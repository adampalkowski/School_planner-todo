...
private val LightColorPalette = PlannerColors(
    brand = Shadow2,
...
private val DarkColorPalette = PlannerColors(
    brand = Shadow7,
...
class PlannerColors(
    ...
    fun copy(): PlannerColors = PlannerColors(
...
private val LocalSocialColors = staticCompositionLocalOf<PlannerColors> {
